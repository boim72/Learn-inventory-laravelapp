              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" action="/store" method="POST">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg -bottom-3
                    @error('name') is-invalid @enderror" id="exampleInputUsername1" placeholder="Username" name="name" value="{{ old('name') }}">
                    @error('name')
                  ...
                  <div class="form-group">
                    ...
                    @error('email') is-invalid @enderror" id="exampleInputEmail1" placeholder="Email" name="email" value="{{ old('email') }}">
                    @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
